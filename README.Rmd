...
The `findSize()` function takes in a power (EBP) specification, priors parameters on the null and alternative hypotheses and determines the sample size needed so that the decision rule made by `bayesBinomTest()` has _at least_ that power (EBP).
```{r}
findSize(.80, 
  a1 = 10, b1 = 10,
  a2 = 2, b2 = 1,
